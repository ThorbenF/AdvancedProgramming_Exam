...
def main():
    files = ['D:/PhD course SISSA-Physics and Chemistry of Biological Systems/Modules/Advanced Programming/Exam/Python/exam_postcard_list{}.txt'.format(i)
             for i in range(10)]
    PstLst = [PostcardList() for f in files]
    # print(PstLst)
    allPstcards = [p.readFile(f) for f, p in zip(files, PstLst)]
    # print(allPstcards)
    ...
    for attr in attributes_to_define:
        if attr not in dir(PstLst[0]):
            print(attr + ' is missing')

    # PstLst[0].writeFile(
    #    'D:/PhD course SISSA-Physics and Chemistry of Biological Systems/Modules/Advanced Programming/Exam/Python/CollectionOfPostcards1.txt')
    # PstLst[1].updateFile(
    #    'D:/PhD course SISSA-Physics and Chemistry of Biological Systems/Modules/Advanced Programming/Exam/Python/CollectionOfPostcards1.txt')
    # PstLst[0].updateLists(
    #    'D:/PhD course SISSA-Physics and Chemistry of Biological Systems/Modules/Advanced Programming/Exam/Python/exam_postcard_list1.txt')
    # PstLst[0].writeFile(
    #    'D:/PhD course SISSA-Physics and Chemistry of Biological Systems/Modules/Advanced Programming/Exam/Python/CollectionOfPostcards2.txt')

    print(PstLst[0].getNumberOfPostcards())
    print(PstLst[2].getPostcardsBySender('Daisy'))
    print(PstLst[0].getPostcardsByReceiver('Minnie'))
    print(PstLst[0].getPostcardsByDateRange(date_range=(datetime.datetime.strptime('2008-1-1', "%Y-%m-%d"),
...
class Test(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(self):
        self._files = ['D:/PhD course SISSA-Physics and Chemistry of Biological Systems/Modules/Advanced Programming/Exam/Python/exam_postcard_list{}.txt'.format(i)
                       for i in range(10)]
